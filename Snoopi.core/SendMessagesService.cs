...
namespace Snoopi.core
{
    public class SendMessagesService
    {
        ...
        private void send_messages (object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var messages = BIdMessageController.GetAllRelevantMessages(now);
                    BIdMessageController.SendMessages(messages, now);
                }
            }
            finally
            {
