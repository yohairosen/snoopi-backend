<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bids.aspx.cs" Inherits="Snoopi.web.Bids" MasterPageFile="Template.master" ValidateRequest="false" %>
...
<asp:Content ID="ContentBids" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <asp:Panel runat="server" DefaultButton="btnSearch">
        ...
        <Localized:LinkButton runat="server" ID="btnExportForCRM" CssClass="button-02" OnClick="btnExportForCRM_Click" LocalizationClass="AppUsers" LocalizationId="ExportForCRMButton"></Localized:LinkButton>
       ...
       <div runat="server" id="linksSearch">
        ...
        <asp:DataGrid CssClass="items-list" ID="dgBids" runat="server" UseAccessibleHeader="true"
            ...
            <Columns>
              ...
              <Localized:TemplateColumn LocalizationClass="Bid" HeaderTextLocalizationId="OrderStatus" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><%#(int)DataBinder.Eval(Container.DataItem, "OrderStatus")!=0 ?
                                          DataBinder.Eval(Container.DataItem, "SuppliedDate")!=null?
                                          BidString.GetText((DataBinder.Eval(Container.DataItem, "OrderStatus").ToString())).Replace("XXX",DataBinder.Eval(Container.DataItem, "SuppliedDate").ToString())
                                          :BidString.GetText((DataBinder.Eval(Container.DataItem, "OrderStatus").ToString()))
                                          :"" %>
                   </ItemTemplate>
                </Localized:TemplateColumn>
                ...
                <Localized:TemplateColumn LocalizationClass="Bid" HeaderTextLocalizationId="IsActive" ItemStyle-CssClass="ltr">
                    ...
                    <ItemTemplate><%# GlobalStrings.GetYesNo((bool)DataBinder.Eval(Container.DataItem, "IsActive"))%></ItemTemplate>
                     ...
                     <Localized:TemplateColumn LocalizationClass="Bid" HeaderTextLocalizationId="Source" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><%# DataBinder.Eval(Container.DataItem, "Source")!=null ?
                                          BidString.GetText((DataBinder.Eval(Container.DataItem, "Source").ToString()))
                                          :"" %>
                   </ItemTemplate>
                </Localized:TemplateColumn>
               <Localized:TemplateColumn LocalizationClass="Bid" HeaderTextLocalizationId="Actions" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate>
                         <Localized:Button runat="server" ID="btnCancelBid"
                            ButtonStyle="ButtonStyle2"
                            OnClick = "btnCancelBid_Click"
                            CommandArgument='<%# Eval("BidId")%>'
                            LocalizationClass="Bid" LocalizationId="CancelBid"  Visible="false"/>
                         
                        <Localized:Button runat="server" ID="btnDeleteBid"
                            ButtonStyle="ButtonStyle2"
                            OnClick = "btnDeletedBid_Click"
                            CommandArgument='<%# Eval("BidId")%>'
                            LocalizationClass="Bid" LocalizationId="DeleteBid"  Visible="false"/>
