<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="ImportCity.aspx.cs" Inherits="Snoopi.web.ImportCity" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" Runat="Server">
    ...
    <Localized:Label runat="Server" BlockMode="true" LocalizationClass="Global" LocalizationId="CityTamplate"></Localized:Label>
    ...
    <asp:PlaceHolder runat="server" ID="phProductsList" Visible="false">
        ...
        <asp:DataGrid CssClass="items-list" ID="dgCity" runat="server" UseAccessibleHeader="true"
            ...
            <Columns>
                <Localized:TemplateColumn LocalizationClass="Global" HeaderTextLocalizationId="Line" ItemStyle-CssClass="ltr">
                ...
                <Localized:TemplateColumn LocalizationClass="Global" HeaderTextLocalizationId="AreaName" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><%# DataBinder.Eval(Container.DataItem, "AreaName")%></ItemTemplate>
                </Localized:TemplateColumn>
                <Localized:TemplateColumn LocalizationClass="Global" HeaderTextLocalizationId="CityName" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><%# DataBinder.Eval(Container.DataItem, "CityName")%></ItemTemplate>
                </Localized:TemplateColumn>
                 <Localized:TemplateColumn LocalizationClass="Global" HeaderTextLocalizationId="Comment" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
