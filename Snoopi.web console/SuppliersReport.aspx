<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuppliersReport.aspx.cs" Inherits="Snoopi.web.SuppliersReport" MasterPageFile="Template.master" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
        ...
        <br />
        <Localized:Label ID="Label12" runat="server" BlockMode="false" AssociatedControlID="txtSearchBidId" LocalizationClass="Bid" LocalizationId="SearchBidId" />&nbsp;
        <asp:TextBox ID="txtSearchBidId" runat="server" />
        <Localized:Label ID="Label10" runat="server" BlockMode="false" LocalizationClass="Orders" LocalizationId="FromDate" />
        <asp:TextBox ID="datepickerFrom" runat="server" ClientIDMode="Static"></asp:TextBox>
        <Localized:Label ID="Label11" runat="server" BlockMode="false" LocalizationClass="Orders" LocalizationId="ToDate" />
    ...
    <asp:PlaceHolder runat="server" ID="phHasItems" Visible="true">
        ...
        <asp:DataGrid CssClass="items-list" ID="dgSuppliers" runat="server" UseAccessibleHeader="true"
            ...
            <Columns>
                ...
                <Localized:TemplateColumn LocalizationClass="Suppliers" HeaderTextLocalizationId="OffersCount" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><a href='/SupplierBids.aspx?Id=<%#((Int64)DataBinder.Eval(Container.DataItem, "SupplierId")).ToString()%>&Action=Offers&FromDate=<%#datepickerFrom.Text.Replace("/", "%2F")%>&ToDate=<%#datepickerTo.Text.Replace("/", "%2F")%>&BidId=<%#txtSearchBidId.Text%>'><%# ((Int32)DataBinder.Eval(Container.DataItem, "BidNum")).ToString().ToHtml()%></a></ItemTemplate>
                </Localized:TemplateColumn>
                <Localized:TemplateColumn LocalizationClass="Suppliers" HeaderTextLocalizationId="WinCount" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><a href='/SupplierBids.aspx?Id=<%#((Int64)DataBinder.Eval(Container.DataItem, "SupplierId")).ToString()%>&Action=Win&FromDate=<%#datepickerFrom.Text.Replace("/", "%2F")%>&ToDate=<%#datepickerTo.Text.Replace("/", "%2F")%>&BidId=<%#txtSearchBidId.Text%>'><%# ((Int32)DataBinder.Eval(Container.DataItem, "OrderNum")).ToString().ToHtml()%></a></ItemTemplate>
                </Localized:TemplateColumn>
                <Localized:TemplateColumn LocalizationClass="Suppliers" HeaderTextLocalizationId="DidntWinCount" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><a href='/SupplierBids.aspx?Id=<%#((Int64)DataBinder.Eval(Container.DataItem, "SupplierId")).ToString()%>&Action=NoWin&FromDate=<%#datepickerFrom.Text.Replace("/", "%2F")%>&ToDate=<%#datepickerTo.Text.Replace("/", "%2F")%>&BidId=<%#txtSearchBidId.Text%>'><%# ((Int32)DataBinder.Eval(Container.DataItem, "BidNum"))-((Int64)DataBinder.Eval(Container.DataItem, "ActiveOrder")) - (Int32)DataBinder.Eval(Container.DataItem, "OrderNum")%></a></ItemTemplate>
                </Localized:TemplateColumn>
                <Localized:TemplateColumn LocalizationClass="Suppliers" HeaderTextLocalizationId="ActiveCount" ItemStyle-CssClass="ltr">
                    <HeaderStyle CssClass="t-center" />
                    <ItemStyle CssClass="t-natural va-middle" />
                    <ItemTemplate><a href='/SupplierBids.aspx?Id=<%#((Int64)DataBinder.Eval(Container.DataItem, "SupplierId")).ToString()%>&Action=Active&FromDate=<%#datepickerFrom.Text.Replace("/", "%2F")%>&ToDate=<%#datepickerTo.Text.Replace("/", "%2F")%>&BidId=<%#txtSearchBidId.Text%>'><%# ((Int32)DataBinder.Eval(Container.DataItem, "ActiveNum")).ToString().ToHtml()%></a></ItemTemplate>
                </Localized:TemplateColumn>
            </Columns>
        </asp:DataGrid>
    </asp:PlaceHolder>
