...
{
    public partial class SuppliersMasterPage : System.Web.UI.MasterPage
    {
        ...
        protected Label helloExit;
        protected LinkButton lbHomePage;
        protected LinkButton nProductManegemet;
        protected LinkButton DealsHistory;
        protected LinkButton MyProfile;
        protected LinkButton ClicksHistory;
        #endregion
        ...
        public bool HasHelloExit
        {
            get { return helloExit.Visible; }
            set { helloExit.Visible = value; }
        }

        public bool HasHomePage
        {
            get { return lbHomePage.Visible; }
            set { lbHomePage.Visible = value; }
        }
        public bool HasProductManegement
        {
            get { return nProductManegemet.Visible; }
            set { nProductManegemet.Visible = value; }
        }
        public bool HasDealsHistory
        {
            get { return DealsHistory.Visible; }
            set { DealsHistory.Visible = value; }
        }
        public bool HasClicksHistory
        {
            get { return ClicksHistory.Visible; }
            set { ClicksHistory.Visible = value; } 
        }
        public bool HasMyProfile
        {
            get { return MyProfile.Visible; }
            set { MyProfile.Visible = value; }
        }
        ...
        {
            base.OnInit(e);
            if (!HttpContext.Current.Request.Url.AbsolutePath.Contains("Login.aspx") && !HttpContext.Current.Request.Url.AbsolutePath.Contains("ForgotPassword.aspx"))
            {
                CheckAuthenticated();
            }
            InitCulture();
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            Page.Title = Resources.AdminMasterPage.GeneralPageTitleSuppliers;
        ...
        {
            string langCode = SuppliersSessionHelper.LangCode();
            try
            {
            ...
            {
                Page.UICulture = Page.Culture = @"auto";
            }
           Page.UICulture = Page.Culture = "he-IL"; // Temporary override
        }
        ...
        //{
        //    //if (permissions.Length == 0 || Permissions.UserHasAnyPermissionIn(SuppliersSessionHelper.UserId(), permissions)) return;
