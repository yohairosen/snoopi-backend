...
{
    public class SupplierLogoutHandler : ApiHandlerBase
    {
        public override void Post(HttpRequest Request, HttpResponse Response, params string[] PathParams)
        {
            ...
            if (IsAuthorizedRequestSupplier(Request, Response, true, out SupplierId))
            {
                ...
                JToken jt;
                string access_token = @"";
                if (inputData.TryGetValue(@"access_token", out jt)) access_token = jt.Value<string>() ?? @"";
                AuthTokens.DeleteAppSupplierAuthToken(access_token);
